   ...
   <div class="container mx-auto">
        ...
        <div class="flex">
                    ...
                    <div class="card w-1/3 rounded overflow-hidden shadow mx-2">
                        <div class="px-6 py-3">
                            <div class="border-b border-grey text-gray-700 font-bold text-xl mb-2 pb-2"> Manual de Uso 1</div>
                            <p class="mt-2">Autor: Daniel Majano</p>
                            <p class="mt-2">Fecha: 08 de Agosto de 2019 </p>
                            <a href="google.com" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 mt-2 rounded inline-flex items-center no-underline">
                    ...
                    <div class="card w-1/3 rounded overflow-hidden shadow mx-2">
                        <div class="px-6 py-3">
                            <div class="border-b border-grey text-gray-700 font-bold text-xl mb-2 pb-2"> Manual de Uso 2</div>
                            <p class="mt-2">Autor: Daniel Majano</p>
